...
//
  ...
  #define CHAMBER_FAN               // Enable a fan on the chamber
    ...
    #define CHAMBER_FAN_MODE 2        // Fan control mode: 0=Static; 1=Linear increase when temp is higher than target; 2=V-shaped curve.
      ...
      #define CHAMBER_FAN_BASE  30   // Base chamber fan PWM (0-255); turns on when chamber temperature is above the target
      #define CHAMBER_FAN_FACTOR 10   // PWM increase per °C above target

    #elif CHAMBER_FAN_MODE == 2
      #define CHAMBER_FAN_BASE  0   // Minimum chamber fan PWM (0-255)
      #define CHAMBER_FAN_FACTOR 20   // PWM increase per °C difference from target
    #endif
...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN 		SERVO0_PIN        // Set a custom pin for the controller fan
...
#define CHAMBER_AUTO_FAN_TEMPERATURE 60
...
#define HOMING_BACKOFF_POST_MM { 5, 0, 10 }  // (mm) Backoff from endstops after homing
...
#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_ABORT "G28XY"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
    ...
    #define PE_LEDS_COMPLETED_TIME  (10*60) // (seconds) Time to keep the LED "done" color before restoring normal illumination
  #endif
